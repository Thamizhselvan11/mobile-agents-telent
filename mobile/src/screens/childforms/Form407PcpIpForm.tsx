...
import { FORM_407_PCP_IP_FIELDS } from '../../data/childFormFields';

type Props = NativeStackScreenProps<RootStackParamList, 'Form407PcpIpForm'>;
 ...
 */
export default function Form407PcpIpForm({ route }: Props) {
  const { auditId, orderNumber, parentFormID, childFormID } = route.params;
  return (
    <GenericChecklistFormScreen
      config={{
        title: 'Form 407 - PCP IP',
        sectionName: 'PCP IP',
        fields: FORM_407_PCP_IP_FIELDS,
        mandatoryIndex: 0,
      }}
