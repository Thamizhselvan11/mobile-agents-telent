...
import { FORM_409_MDF_IP_FIELDS } from '../../data/childFormFields';

type Props = NativeStackScreenProps<RootStackParamList, 'Form409MdfIpForm'>;
 ...
 */
export default function Form409MdfIpForm({ route }: Props) {
  const { auditId, orderNumber, parentFormID, childFormID } = route.params;
  return (
    <GenericChecklistFormScreen
      config={{
        title: 'Form 409 - MDF IP',
        sectionName: 'MDF IP',
        fields: FORM_409_MDF_IP_FIELDS,
        mandatoryIndex: 0,
      }}
