...
import { FORM_501_OH_REPAIR_FIELDS } from '../../data/childFormFields';

type Props = NativeStackScreenProps<RootStackParamList, 'Form501OhRepairForm'>;
 ...
 */
export default function Form501OhRepairForm({ route }: Props) {
  const { auditId, orderNumber, parentFormID, childFormID } = route.params;
  return (
    <GenericChecklistFormScreen
      config={{
        title: 'Form 501 - OH REPAIR',
        sectionName: 'OH REPAIR',
        fields: FORM_501_OH_REPAIR_FIELDS,
        mandatoryIndex: 0,
      }}
